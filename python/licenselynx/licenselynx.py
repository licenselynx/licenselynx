...
class LicenseLynx:
    ...
    @staticmethod
    def map(license_name: str, risky: bool = False, extra: Extra = Extra.NONE) -> Optional[LicenseObject]:
        """
        ...
        try:
            ...
            if not license_object and extra != Extra.NONE:
                extra_map_key = f"{extra.value}Map"
                extra_map = instance.merged_data.extra_maps.get(extra_map_key)
                if extra_map:
